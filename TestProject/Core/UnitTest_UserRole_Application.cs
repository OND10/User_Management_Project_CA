...
namespace TestProject.Core
{
    public class UnitTest_UserRole_Application:DtoFakeBaseModel
    {
        ...
        {
            // Arrange
            var callmocking = new Mock<IUserRoleService>();
            ...
            // Acting
            IUserRoleService mockedrole = callmocking.Object;
        ...
        public async Task UserRole_CreateAsync_Test_Method()
        {
            ...
            callmocking.Setup(userrole => userrole.CreateAsync(It.IsAny<UserRoleRequestDTO>())).
        ...
        public async Task UserRole_Delete_Method_Test()
        {
            ...
            var callmocking = new Mock<IUserRoleService>();
            //mocking the IUserRoleService to get the specified method
            callmocking.Setup(role => role.DeleteAsync(It.IsAny<UserRoleRequestDTO>())).
